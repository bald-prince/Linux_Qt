...
Board::Board(QWidget *parent) : QMainWindow(parent)
{
    ...
    btnLed->setGeometry(150,250,btnLed->width(),btnLed->height());
    ...
    btnBeep->setGeometry(450,250,btnBeep->width(),btnBeep->height());
    ...
    icmwidget1->setGeometry(220,170,180,180);
    labValue[0] = new QLabel(thirdpage);
    labValue[0]->setGeometry(275,320,80,40);
    ...
    icmwidget2->setGeometry(420,170,180,180);
    labValue[0] = new QLabel(thirdpage);
    labValue[0]->setGeometry(475,320,80,40);
    ...
    icmwidget3->setGeometry(620,170,180,180);
    labValue[0] = new QLabel(thirdpage);
    labValue[0]->setGeometry(675,320,80,40);
    ...
    icmwidget4->setGeometry(100,350,180,180);
    labValue[0] = new QLabel(thirdpage);
    labValue[0]->setGeometry(155,500,80,40);
    ...
    icmwidget5->setGeometry(320,350,180,180);
    labValue[0] = new QLabel(thirdpage);
    labValue[0]->setGeometry(380,500,80,40);
    ...
    icmwidget6->setGeometry(540,350,180,180);
    labValue[0] = new QLabel(thirdpage);
    labValue[0]->setGeometry(600,500,80,40);
...
void Board::chart_init()
{
    ...
    chartView->setGeometry(0,80,824,480);
